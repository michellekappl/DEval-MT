...
def translate_dataset(
    ...
    output_dir: str = "../../study/data/translations",
    ...
    Writes translations directly to files. (default folder ../../study/data/translations)
    ...
    Args:
        ...
        output_dir: Directory to save translation files (default: "../../study/data/translations")
...
if __name__ == "__main__":
    dataset_path = "../../study/data/deval_dataset.csv"
