...
if __name__ == "__main__":
    # Retranslate ERROR: lines in the study's translation files.
    # Pass only_file="<lang>_<provider>.txt" to process just one file first.
    retranslate_errors(
        csv_path="../../study/data/deval_dataset.csv",
        translation_dir="../../study/data/translations",
        max_retries=3,
        retry_delay=2.0,
    )
