                ...
                for i, sentence in enumerate(sentences):
                    try:
                        ...
                        if prov == "systran":
                            ...
                            translated_sentence = translate_text_google(sentence, lang).translations[0].translated_text
                        elif prov == "deepl":
                        ...
                        if (i + 1) % progress_interval == 0:
                            ...
                            print(f"[{prov}] {progress_percent:.0f}% - Translated {i + 1}/{len(sentences)} sentences for {lang}")
...
if __name__ == "__main__":
    ...
    translate_dataset(dataset_path, ["es", "fr"], ["systran", "google"], overwrite_translation=False)