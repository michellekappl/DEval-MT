...
def translate_text_google(text: str, target: str):
    ...
    # Initialize Translation client with NMT model.
...
def translate_text_google_llm(text: str, target: str) -> translate_v3.TranslationServiceClient:
    """Translate Text from a Source language to a Target language.
    Args:
        text: The content to translate.
        source_language_code: The code of the source language.
    ...
    # Initialize Translation client with LLM model.
