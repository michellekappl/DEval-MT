...
class HebrewMorphAnalyzer(BaseMorphologicalAnalyzer):
    """Morphological analyzer for Hebrew, using spaCy's Hebrew tokenizer.
    Gender is inferred from word-final characters rather than spaCy's
    morphological tagger (Hebrew has no pretrained tagger pipeline)."""
